...
```
irm "https://github.com/jiroaku/powershell-profile/raw/main/setup.ps1" | iex
```
...
### 1) You will find a downloaded `JetBrainsMono.zip` file in the folder you executed the script from. Follow these steps to install the patched `JetBrains Mono` nerd font family:

1. Extract the `JetBrainsMono.zip` file.
...
This is a personal fork of the PowerShell Profile project. The original project and idea were created by **Chris Titus Tech**.

- Original repository: [ChrisTitusTech/powershell-profile](https://github.com/ChrisTitusTech/powershell-profile)
- This fork is maintained by jiroaku for personal use and customizations.
